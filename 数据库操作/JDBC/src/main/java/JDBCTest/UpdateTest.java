...
public class UpdateTest {
    public static void main(String[] args) throws SQLException {
        ...
        try (Connection cnn = DriverManager.getConnection(jdbcUrl, jdbcUsername, jdbcPassword)) {
            try (PreparedStatement ps = cnn.prepareStatement("INSERT INTO students (name, gender, grade, score) VALUES (?, ?, ?, ?)")) {
    ...
    static List<Student> queryStudents() throws SQLException {
        ...
        try (Connection cnn = DriverManager.getConnection(jdbcUrl, jdbcUsername, jdbcPassword)) {
            try (PreparedStatement ps = cnn.prepareStatement("SELECT * FROM students")) {
